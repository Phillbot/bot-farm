nbu-exchange-bot-start  = 
                          ...
                          You can get NBU exchange rate by command /r and /m or send /sub for get it automatically every day at 9am and 6pm
nbu-exchange-bot-subscribe-deactivated = Done, subscribe deactivated
nbu-exchange-bot-subscribe-not-active = Subscribe is not active. Send /sub to activate it
...
react-clicker-bot-start-command = Hi, its beta Atom-clicker Bot! Test it all!
